...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        classified_label = results_dic[key][1]
        comparison = results_dic[key][2]
        actual_is_dog = results_dic[key][3]
        classified_is_dog = results_dic[key][4]
        ...
        if actual_is_dog == classified_is_dog:
            if actual_is_dog == 1:
                results_stats_dic['n_correct_dogs'] += 1
            else:
                results_stats_dic['n_correct_notdogs'] += 1
        
        if actual_is_dog == 1 and comparison == 1:
